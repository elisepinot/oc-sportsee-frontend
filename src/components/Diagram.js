...
import { DiagramModel } from '../data/modelisation';
...
function Diagram() {
  ...
  // Création d'une instance de la classe de modélisation
  const model = new DiagramModel(userPerformance.data, userPerformance.kind);
